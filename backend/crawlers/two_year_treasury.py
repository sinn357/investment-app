...
def get_two_year_treasury():
    """
    2년 국채수익률 (2-Year Treasury Yield) 데이터를 크롤링합니다.
    investing.com에서 2년 국채수익률 데이터를 가져와 표준 형식으로 반환합니다.
    """
    ...
    try:
        ...
        print(f"2년 국채수익률 데이터 처리 중 오류 발생: {e}")
        return {"error": f"데이터 처리 실패: {str(e)}"}

if __name__ == "__main__":
    print("2년 국채수익률 데이터 테스트 중...")
    result = get_two_year_treasury()
    print("결과:", result)